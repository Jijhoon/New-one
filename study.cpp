...
int main()
{
    int x = true; // true, false는 소문자로 작성!
    ...
    std::cout << "statement3"<<std::endl; // 여기서부터는 if block에 들어있는 것이 아니라 그냥 밖에 나와있다.
    {
        std::cout << "statement4"<<std::endl; // --> 정상작동
    }    
    /*
    (
        std::cout << "statement5"<<std::endl;  --> 오류
    )
